...
## a plot for Global_active_power variable
...
## Open PNG device and create 'plot2.png' in the working directory
png(filename = "plot2.png") # Width and height are equal 480 px by default
